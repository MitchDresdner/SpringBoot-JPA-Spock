...
public class ReadingListApplicationTests {
    ...
    public void saveABook() throws Exception {
        ...
        Book saved = repo.save(new Book("Mitch", "TITLE", "AUTHOR", "1234567890", "DESCRIPTION"));

        saved = repo.save(new Book("Mitch", "TITLE1", "AUTHOR1", "1234567890-1", "DESCRIPTION1"));
        saved = repo.save(new Book("Mitch", "TITLE2", "AUTHOR2", "1234567890-2", "DESCRIPTION2"));
        saved = repo.save(new Book("Mitch", "TITLE3", "AUTHOR3", "1234567890-3", "DESCRIPTION3"));
        ...
        assertEquals("Mitch", found.get(0).getReader());
    }
